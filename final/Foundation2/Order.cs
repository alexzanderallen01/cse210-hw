...
public class Order
{
    ...
    {
        double shippingCost = _customer.isFromUSA() ? 5 : 35;       //again credit to Garret. Thanks Friend.
        return shippingCost;
    }
    ...
    public string GenerateTotalCost()
    {
        ...
        totalCost += "Total: $" + Math.Round(CalculateTotalPrice(),2);
